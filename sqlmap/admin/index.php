...
<head>
  ...
  <link rel="stylesheet" href="/sqlmpui/css/bootstrap.min.css">
  <link rel="stylesheet" href="/sqlmpui/css/css.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
  <script src="/sqlmpui/js/bootstrap.min.js"></script>
  <script src="/sqlmpui/js/sqlmap.js"></script>
</head>
...
<body>
  ...
  */
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form class="form-horizontal" role="form" id="myAdminID" action="/sqlmpui/admin/index.php" method="POST">
                      ...
                      <table class="table table-hover" id="adminTasksDisplayTable">
                        ...
                        <tbody>
                          ...
                          foreach ($taskList['tasks'] as $t) {
                            ...
                            echo "<td> <a href=\"/sqlmpui/admin/index.php?task=" . htmlentities($t, ENT_QUOTES, 'UTF-8') . "&action=conf\" target=\"_blank\">Conf</a> </td>";
                            if ($status['status'] == 'running') {
                              echo "<td> <a href=\"/sqlmpui/admin/index.php?task=" . htmlentities($t, ENT_QUOTES, 'UTF-8') . "&action=stop\">Stop</a> </td>";
                              echo "<td> <a href=\"/sqlmpui/admin/index.php?task=" . htmlentities($t, ENT_QUOTES, 'UTF-8') . "&action=kill\">Kill</a> </td>";
                            } else {
                              echo "<td> - </td>";
                              echo "<td> - </td>";
                            }
                            echo "<td> <a href=\"/sqlmpui/admin/index.php?task=" . htmlentities($t, ENT_QUOTES, 'UTF-8') . "&action=del\">Del</a> </td>";
                            echo "</tr>";
                          }
                          ?>
                        </tbody>
  ...
  <div class="footer" align="center">
    <a href="/sqlmpui/admin/logout.php">Logout</a><br />
